...
import com.myboard.toy.sales.domain.dto.*;
...
public class RestCartItemController2 {
    ...
    public ResponseEntity<Map<String, String>> increaseAmountWhenPushTheButton(
        ...
        try {
            ...
            Cart cart = cartService.findCartByAccountId2(accountId);
    ...
    **/
    ...
    public ResponseEntity<?> getCartList(
        ...
        List<CartListDto> cartList = cartService.getCartListV2(userId);
    ...
    /* 증가 */
    @PostMapping("/changeItem/{userId}/{itemId}")
    public ResponseEntity<Map<String, String>> changeAmount(
        ...
        try {
            ...
            Cart cart = cartService.findCartByAccountId2(userId);

            cartItemService.updateCartItemAmount2(cart, itemId,newCount);
